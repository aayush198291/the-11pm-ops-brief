...
> **All operational data is 100% synthetic mock data**, generated by `setup_data.py` for this hackathon. No real company, customer, or shipment data is used anywhere. Names, volumes, and dollar figures are fabricated to be realistic but are entirely fictional.
...
- **8 FCs**, **5 carriers**, **8,000 customers** — all synthetic mock data, no real company data
